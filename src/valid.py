...
if __name__ == '__main__':
    ...
    test_image_path = 'F:/SJJ/CA/data/demo/'
    im_names = os.listdir(test_image_path)

    #im_names = ['00000.jpg', '00001.jpg', '00002.jpg', '00003.jpg','00004.jpg', '00029.jpg']
    for im_name in im_names:
        print('~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~')
        print('Demo for data/demo/{}'.format(im_name))
        demo(sess, net, im_name)
        plt.savefig(cfg.FLAGS2["data_dir"] + '/test_result20000/' + im_name)
